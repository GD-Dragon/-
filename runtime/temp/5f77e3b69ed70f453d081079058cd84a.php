<?php /*a:3:{s:89:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\permissioncate\list.html";i:1562590487;s:76:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\header.html";i:1563420714;s:77:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\foother.html";i:1562166675;}*/ ?>
 <!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<script>
	function up_action(){
		...
		$.ajax({
			url:"<?php echo url('permissioncate/updateAction'); ?>",
			type:'post',
			data:{
				id:id,
				name:name,
		...
		function mydelete(id){
			...
			$.ajax({
				url:"<?php echo url('permissioncate/delete'); ?>",
				type:'post',
				data:{
					id:id,
					__token__:__token__,
		...
		function datadel(){
			...
			if (r==true)
			{
				...
				var __token__=$('#token_delete').html()
				$.ajax({
					url:"<?php echo url('permissioncate/deleteMore'); ?>",
					type:'post',
					data:{
						id:id,
						__token__:__token__,
		...
		$(document).ready(function(){
			...
			$(document).on("blur",".inputname",function(){
				...
				$("#add").click(function(){
					...
					$.ajax({
						url:"<?php echo url('permissioncate/addAction'); ?>",
						type:'post',
						data:{
							name:name,
							description:description,
