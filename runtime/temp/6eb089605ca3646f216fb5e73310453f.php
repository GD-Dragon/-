<?php /*a:3:{s:79:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\role\list.html";i:1563284775;s:76:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\header.html";i:1563505880;s:77:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\foother.html";i:1562166675;}*/ ?>
. <!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
					 <button type="button" class="btn btn-success" id="add" name="" onClick=""><i class="Hui-iconfont">&#xe600;</i> <a href="<?php echo url('role/add'); ?>">添加</a></button>
...
<script>
	function up_action(){
		...
		$.ajax({
			url:"<?php echo url('role/updateaction'); ?>",
				type:'post',
				data:{
					__token__:__token__,
					id:id,
	...
	function modaldemo(id,name,description){
		...
		$.ajax({
			url:"<?php echo url('role/mypermissionShow'); ?>",
			data:{
				id:id,
			},
			success:function(res){
	...
	show()
     ...
     function del() {
        ...
        var __token__=$('#__token__').val()
     	...
     	$.ajax({
     		url:"<?php echo url('role/deletemore'); ?>",
     	    type:'post',
     		data:{
     			id:id,
     			__token__:__token__
