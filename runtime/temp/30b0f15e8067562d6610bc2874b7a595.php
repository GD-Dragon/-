<?php /*a:3:{s:79:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\goods\add.html";i:1563525238;s:76:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\header.html";i:1563505880;s:77:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\foother.html";i:1562166675;}*/ ?>
. <!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<script>
	$('#add').click(function(){
		...
		$.ajax({
			url:'<?php echo url("goods/addaction"); ?>',
			type:'post',
			data:{
				name:name,
				brand_id:brand_id,
	...
	$.ajax({
		url:'<?php echo url("goods/showcate"); ?>',
	    success:function (res) {
