<?php /*a:3:{s:85:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\permission\list.html";i:1562590489;s:76:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\header.html";i:1563326384;s:77:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\foother.html";i:1562166675;}*/ ?>
 <!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a href="<?php echo url('attrdetails/list'); ?>" title="属性管理">属性分类管理</a></li>
		</ul>
	</dd>
</dl>
		<dl id="menu-comments">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a  onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a></span>
				<span id='token_delete' hidden=""><?php echo htmlentities($token); ?></span>
...
<script>
		...
		$.ajax({
			url:"<?php echo url('permission/updateaction'); ?>",
				type:'post',
				data:{
					__token__:__token__,
					id:id,
	...
	function getCate(){
		$.ajax({
		url:'<?php echo url("permissioncate/show"); ?>',
		dataType:'json',
		success:function(res){
			console.log(res)
			var option=''
...
show()
	...
	$(document).on('click','.delete_one', function(){
			...
			var __token__ =$('#__token__').val()
			$.ajax({
				url:"<?php echo url('permission/delete'); ?>",
				type:'post',
				data:{
					__token__:__token__,
					id:id,
	...
	$(document).ready(function(){
		...
		var category_id=$('#category_id').val()
			$.ajax({
			url:'<?php echo url("permission/addaction"); ?>',
			type:'post',
			data:{
				__token__:__token__,
				name:name,
