<?php /*a:3:{s:83:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\goodsattr\add.html";i:1563499634;s:76:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\header.html";i:1563420714;s:77:"D:\PHPstudy\PHPTutorial\WWW\03kj\shopping\application\admin\view\foother.html";i:1562166675;}*/ ?>
 <!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">商品细分属性</label>
			<div class="formControls col-xs-8 col-sm-9">
				
				<select name="attr_details_id" id="attr_details_id">
					<option value="0">商品细分属性</option>
				</select>
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">网站商品：</label>
			<div class="formControls col-xs-8 col-sm-9">
